...
<section class="fe-page-hero text-white">
    <div class="container text-center" style="padding: 3.5rem 0;">
        <h1 class="fe-hero-title" style="font-size: 2.5rem;">Frequently Asked Questions</h1>
        <p class="fe-hero-subtitle mx-auto">Find answers to common questions about TVET Revision.</p>
    </div>
</section>
...
<section class="fe-section" style="background: var(--fe-bg);">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <!-- Getting Started -->
                <h4 class="fw-bold mb-4" style="font-size: 1.15rem;"><i class="bi bi-rocket-takeoff me-2" style="color: var(--fe-primary);"></i>Getting Started</h4>
                <div class="accordion fe-accordion mb-5" id="gettingStartedAccordion">
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#gs1">What is TVET Revision?</button>
                        </h2>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#gs2">How do I create an account?</button>
                        </h2>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#gs3">Can I change my course after registration?</button>
                        </h2>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#gs4">Is TVET Revision free to use?</button>
                        </h2>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#gs5">Which courses are available?</button>
                        </h2>
                ...
                <!-- Using the Platform -->
                <h4 class="fw-bold mb-4" style="font-size: 1.15rem;"><i class="bi bi-laptop me-2" style="color: var(--fe-primary);"></i>Using the Platform</h4>
                <div class="accordion fe-accordion mb-5" id="usingPlatformAccordion">
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#up1">How do I start revising?</button>
                        </h2>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#up2">How do I save questions for later?</button>
                        </h2>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#up3">Can I track my learning progress?</button>
                        </h2>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#up4">Can I search for specific topics?</button>
                        </h2>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#up5">Can I access TVET Revision on my phone?</button>
                        </h2>
                ...
                <h4 class="fw-bold mb-4" style="font-size: 1.15rem;"><i class="bi bi-credit-card me-2" style="color: var(--fe-primary);"></i>Subscription & Payment</h4>
                <div class="accordion fe-accordion mb-5" id="subscriptionAccordion">
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#sp1">What are the benefits of premium subscription?</button>
                        </h2>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#sp2">How do I subscribe to premium?</button>
                        </h2>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#sp3">What payment methods do you accept?</button>
                        </h2>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#sp4">Do subscriptions auto-renew?</button>
                        </h2>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#sp5">Can I get a refund?</button>
                        </h2>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#sp6">I paid but didn't receive premium access. What should I do?</button>
                        </h2>
                ...
                <!-- Account & Security -->
                <h4 class="fw-bold mb-4" style="font-size: 1.15rem;"><i class="bi bi-shield-check me-2" style="color: var(--fe-primary);"></i>Account & Security</h4>
                <div class="accordion fe-accordion mb-5" id="accountAccordion">
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#as1">How do I change my password?</button>
                        </h2>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#as2">I forgot my password. What should I do?</button>
                        </h2>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#as3">Can I update my profile information?</button>
                        </h2>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#as4">How do I delete my account?</button>
                        </h2>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#as5">Is my data safe?</button>
                        </h2>
                ...
                <!-- Technical Issues -->
                <h4 class="fw-bold mb-4" style="font-size: 1.15rem;"><i class="bi bi-wrench me-2" style="color: var(--fe-primary);"></i>Technical Issues</h4>
                <div class="accordion fe-accordion mb-5" id="technicalAccordion">
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#ti1">The website is loading slowly. What can I do?</button>
                        </h2>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#ti2">I can't log in to my account. What should I do?</button>
                        </h2>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#ti3">Images or content are not loading properly</button>
                        </h2>
                ...
                <!-- Contact CTA -->
                <div class="fe-cta-card text-center">
                    <h5 class="fw-bold mb-3">Still have questions?</h5>
                    <p style="color: rgba(255,255,255,0.8); margin-bottom: 1.25rem;">Can't find what you're looking for? Our support team is here to help!</p>
                    <a href="{{ route('contact') }}" class="fe-btn fe-btn-white fe-btn-lg">
